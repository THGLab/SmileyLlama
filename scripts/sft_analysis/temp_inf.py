...
def inference_and_analysis(llm_inference_obj, smilesfile, generation_params):
    ...
    completions = []
    generation = llm_inference_obj.generate_smiles_strings(prompts, 128, 256, generation_params)
...
if __name__=="__main__":
    ...
    sl = sl_inference.InferenceObject(sl_path, 'THGLab/SmileyLlama-3.1-8B-Instruct-1.1')
