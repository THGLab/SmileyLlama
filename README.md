...
### vina-gpu
To reproduce our Mpro optimization, you'll need to install iMiner and Vina GPU. However, this will generally involve recompiling Vina GPU. To recreate the iMiner environment, you'll need to create the same `vina` environement
```
cd envs
conda env create -f vina.yml -n vina
conda activate vina
...
Then, also create the vina-gpu environment.
```
conda deactivate
cd envs
